...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean processandoJogada = false;
    ...
    private int jogadorVez = 1; // 1 para o Player 1 e 2 para o Player 2
    ...
    public void btDuplaClick(View view) {
        ...
        tvJogador1.setText("Player 1: " + jogador1);
        tvJogador2.setText("Player 2: " + jogador2);
        tvJogador.setText("Vez do " + jogadorVez );
    ...
    private void NovoJogo() {
        ...
        listaCartas.add(new Carta(R.drawable.grimpeirinho));
        listaCartas.add(new Carta(R.drawable.grimpeirinho));

        listaCartas.add(new Carta(R.drawable.onca_parda));
        listaCartas.add(new Carta(R.drawable.onca_parda));

        listaCartas.add(new Carta(R.drawable.anta));
        listaCartas.add(new Carta(R.drawable.anta));

        listaCartas.add(new Carta(R.drawable.capivara));
        listaCartas.add(new Carta(R.drawable.capivara));

        listaCartas.add(new Carta(R.drawable.tatu));
        listaCartas.add(new Carta(R.drawable.tatu));

        listaCartas.add(new Carta(R.drawable.gralha));
        listaCartas.add(new Carta(R.drawable.gralha));

        listaCartas.add(new Carta(R.drawable.bugio));
        listaCartas.add(new Carta(R.drawable.bugio));

        listaCartas.add(new Carta(R.drawable.papagaio));
        listaCartas.add(new Carta(R.drawable.papagaio));

        listaCartas.add(new Carta(R.drawable.paca));
        listaCartas.add(new Carta(R.drawable.paca));
        ...
        for(int i = 0; i < listaCartas.size(); i++) {
            ...
            imageButton.setImageResource(R.drawable.verso);
    ...
    private void virarCarta(Carta carta) {
        if(carta.estaVirada() || carta1 == carta || carta2 == carta || processandoJogada) {
            return;
        }
    ...
    private void verificarPar() {
        if (carta1.getIdImagem() == carta2.getIdImagem()) {
            ...
            handler.postDelayed(() -> {
                carta1.getImageButton().setImageResource(R.drawable.verso);
                carta2.getImageButton().setImageResource(R.drawable.verso);
